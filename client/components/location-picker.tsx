...
export function LocationPicker({ address, form }: { form: UseFormReturn<SearchSchemaType>, address: CarLocation[] }) {
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          role="combobox"
          aria-expanded={open}
          className="w-full justify-between text-gray-900 text-sm bg-white-200 border-none"
        >
          {value
